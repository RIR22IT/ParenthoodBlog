...
if (isset($_SESSION['id']) && isset($_SESSION['email'])) {
	...
	if (mysqli_num_rows($run) > 0) {
		...
		$hobbies      = $row['hobbies'];
		$fav_music    = $row['fav_music'];
		$fav_TV       = $row['fav_TV'];
		$fav_book     = $row['fav_book'];
		$fav_movie    = $row['fav_movie'];
		$fav_writer   = $row['fav_writer'];
		$fav_game     = $row['fav_game'];
		$other_interest = $row['other_interest'];
	}
?>
								...
								<div id="collapseOne1" class="accordion-collapse collapse show" aria-labelledby="headingOne1" data-bs-parent="#accordionExample1">
									<div class="accordion-body">
										<ul class="your-profile-menu">
											...
											<li>
												<a href="YourAccount-EducationAndEmployement.php">Education and Employement</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<ul class="notification-list">
									...
									<li class="with-comment-photo-wrap">
										<div class="with-comment-photo">
											...
											<div class="notification-event">
												<div> <a href="#" class="h6 notification-friend">Sarah Hetfield</a> commented on your <a href="#" class="notification-link">photo</a>. </div> <span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">Yesterday at 5:32am</time></span>
											</div> <span class="notification-icon"> <svg class="olymp-comments-post-icon">
													<use xlink:href="#olymp-comments-post-icon"></use>
												</svg> </span>
										</div>
										<div class="comment-photo"> <img loading="lazy" src="img/comment-photo1.webp" alt="photo" width="40" height="40"> <span>“She looks incredible in that outfit! We should see each...”</span> </div>
										<div class="more"> <svg class="olymp-three-dots-icon">
												<use xlink:href="#olymp-three-dots-icon"></use>
				...
				<div class="col col-xl-9 order-xl-2 col-lg-9 order-lg-2 col-md-12 order-md-1 col-sm-12 col-12">
					<div class="ui-block">
						...
						<div class="ui-block-content">
							...
							<form action="info-handle.php" method="POST">
								<div class="row">
									...
									<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
										...
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="hobbies"><?php echo $hobbies ?></textarea>
										</div>

										<label class="control-label">Favourite TV Shows</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_TV"><?php echo $fav_TV ?></textarea>
										</div>

										<label class="control-label">Favourite Movies</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_movie"><?php echo $fav_movie ?></textarea>
										</div>

										<label class="control-label">Favourite Games</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_game"><?php echo $fav_game ?></textarea>
										</div>
									...
									<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
										...
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_music"><?php echo $fav_music ?></textarea>
										</div>

										<label class="control-label">Favourite Books</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_book"><?php echo $fav_book ?></textarea>
										</div>

										<label class="control-label">Favourite Writers</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="fav_writer"><?php echo $fav_writer ?></textarea>
										</div>

										<label class="control-label">Other Interests</label>
										<div class="form-group label-floating">
											<textarea class="form-control" placeholder="" name="other_interest"><?php echo $other_interest ?></textarea>
										</div>

										<input type="hidden" name="id" value='<?php echo $id ?>'>
										<input type="hidden" name="hobbies_id" value='<?php echo $hobbies_id ?>'>

									</div>
									<!-- <button class="btn btn-primary btn-lg full-width" name="hobbies" type="submit">Save all Changes</button> -->

									<div class="col col-lg-12 col-md-12 col-sm-12 col-12">
										<button class="btn btn-primary btn-lg full-width" name="btnHobby" type="submit">Save all Changes</button>
									</div>
