                                    ...
                                    <li class="with-comment-photo-wrap">
                                        <div class="with-comment-photo">
                                            ...
                                            <div class="notification-event">
                                                ...
                                                </div> <span class="notification-date"><time class="entry-date updated" datetime="2004-07-24T18:18">Yesterday at 5:32am</time></span>
                                            </div> <span class="notification-icon"> <svg class="olymp-comments-post-icon">
                                                    <use xlink:href="#olymp-comments-post-icon"></use>
                                                </svg> </span>
                                        </div>
                                        <div class="comment-photo"> <img loading="lazy" src="img/comment-photo1.webp" alt="photo" width="40" height="40"> <span>“She looks incredible in that
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" placeholder="" type="text" name="firstName" value="<?php echo $firstName; ?>">
                                        </div>

                                        <div class="form-group label-floating">
                                            <label class="control-label">Your Email</label>
                                            <input class="form-control" placeholder="" type="email" value="<?php echo $email; ?>" disabled>
                                        </div>

                                        <!-- <div class="form-group"> -->
                                        <p>Date of Birth: <input type="date" id="datepicker" name="birth" value="<?php echo $user_dob; ?>"></p>
                                        <!-- </div> -->
                                    ...
                                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="form-group label-floating">
                                            ...
                                            <input class="form-control" placeholder="" type="text" name="lastName" value="<?php echo $lastName; ?>">
                                        </div>

                                        <div class="form-group label-floating">
                                            <label class="control-label">Your Occupation</label>
                                            <input class="form-control" placeholder="" type="text" name="occupation" value="<?php echo $user_occupation; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" placeholder="Write a little description about you" name="description"><?php echo $user_description; ?></textarea>
                                        </div>
								...
								<div class="form-group label-floating is-select">
                                    ...
                                    <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group with-icon label-floating">
                                            ...
                                            <input class="form-control" type="text" name="fb" value="<?php echo $user_fb; ?>">
