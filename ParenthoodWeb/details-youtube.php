                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown active">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="active"><a href="details-youtube.html">Post - Video - Youtube</a></li>
                            ...
                            <aside class="col-sm-4 col-md-3 rightSidebar">
                                ...
                                <div class="donation_widget">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input class="form-control" id="f_name3" type="text" placeholder="First name">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                            ...
                            <div class="col-sm-3 col-md-3">
                                <div class="footer-box">
                                    ...
                                    <div class="textwidget"><p>457 BIgBlue Street, Suite 4A<br>
                                            ...
                                            <a href="mailto:stylo@edge-themes.com">info@example.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
