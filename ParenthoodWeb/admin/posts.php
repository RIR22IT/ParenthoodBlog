        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 1300px;"><br />
                    <!-- Page Heading -->
                    <center>
                        <h1 class="h3 mb-1 text-gray-800">POSTS</h1>
                        <hr />
                    </center>
                    ...
                    <form method="POST" action="posts.php" enctype="multipart/form-data" style="width: 70%">
                        <div class="row">
                            ...
                            <div class="col-15">
                                ...
                                <input type="text" name="mainTitle" class="form-control" value="" required><br>
                            </div>

                            <div class="col-15">
                                <label for="img">Main Image* (please upload 865 x 486 dimension)</label>
                                <input type="file" class="form-control" id="img" name="img" onchange="getImagePreview(event)" required>
                                <br /><br />
                                <center>
                            ...
                            <div class="col-15">
                                ...
                                <input type="text" name="subTitle" class="form-control" value=""><br>
                            </div>
                            <br /><br /><br />
                            ...
                            <div class="col-15">
                                ...
                                <textarea id="description" class="form-control ckeditor" name="description" value="" required></textarea>
                            </div>

                        </div>
                        <br />
                        <div class="col-md-20">
                            <button type="submit" name="postBtn" class="btn btn-primary">Add</button>
                        </div>
