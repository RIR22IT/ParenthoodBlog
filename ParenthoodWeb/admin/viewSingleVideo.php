...
<head>
    ...
    <title>ADMIN PANEL - VIEW SINGLE VIDEO</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="width: 1300px;"><br />
                    ...
                    <div class="container-fluid" style="width: 1300px;"><br />
                        ...
                        <center>
                            <h1 class="h3 mb-1 text-gray-800">VIEW SINGLE VIDEO DETAILS</h1>
                        </center><br>
                                ...
                                <table class="table table-bordered" style="width: 90%">
                                    <thead>
                                        <tr class="bg-primary">
                                            ...
                                            <th style="color: white">Category Type</th>
                                    ...
                                    ?>
                                            ...
                                            <?php
                                            $url = $row['videoLink'];
                                            $videoLink = substr($url, strpos($url, "v=") + 2);
                                            ?>

                                            <tr>
                                                <td><?php echo $i++ ?></td>
                                                <td>
                                                    <iframe width="150" height="100" src="https://www.youtube.com/embed/<?php echo $videoLink; ?>" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="editSingleVideo.php?s_edit=<?php echo $row['s_id']; ?>" class="edit_btn"><i class="fas fa-edit" style="color:black"></i></a>
                                                </td>

                                                <td>
                                                    <a href="php_code.php?s_del=<?php echo $row['s_id']; ?>" class="del_btn"><i class="fa fa-trash" style="color:black"></i></a>
                                                </td>
                                            </tr>
