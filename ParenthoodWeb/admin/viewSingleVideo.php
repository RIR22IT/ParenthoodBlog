                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <iframe width="150" height="100"
                                                src="https://www.youtube.com/embed/<?php echo $videoLink; ?>"
                                                frameborder="0"
                                        ...
                                        <td>
                                            <a href="editSingleVideo.php?s_edit=<?php echo $row['s_id']; ?>"
                                                class="edit_btn"><i class="fas fa-edit" style="color:black"></i></a>
                                        </td>

                                        <td>
                                            <a href="php_code.php?s_del=<?php echo $row['s_id']; ?>" class="del_btn"><i
