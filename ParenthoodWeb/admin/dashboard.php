...
if(isset($_POST['link']))
{
 ...
 {
  move_uploaded_file($file, 'post/' . $new_image_name);
//   $function_number = $_GET['CKEditorFuncNum'];
  $url = 'http://localhost/ParenthoodBlog/ParenthoodWeb/post/' . $new_image_name;
  $message = '';
...
<head>
    ...
    <title>ADMIN PANEL - ADD FOOTER IMAGES</title>
