                    ...
                    <form method="POST" action="php_code.php" enctype="multipart/form-data" style="width: 70%">
                        <div class="row">
                            ...
                            <div class="col-15">
                                ...
                                <input type="text" name="mainTitle" class="form-control" value="<?php echo $mainTitle ?>" required><br>
                            </div>

                            <div class="col-15">
                                <label for="img">Main Image* (please upload 865 x 486 dimension)</label>
                                <input type="file" class="form-control" id="img" name="img" onchange="getImagePreview(event)">
                                <br /><br />
                                <center>
                            ...
                            <div class="col-15">
                                ...
                                <input type="text" name="subTitle" class="form-control" value="<?php echo $subTitle ?>"><br>
                            </div>
                            <br /><br /><br />
