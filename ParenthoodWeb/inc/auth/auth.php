                    ...
                    <div class="tab-pane fade in active" id="login">
                        <div class="form-content text-center">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="f_name" id="f_name2" placeholder="Username or email"
                                    type="text">
                            </div>
                            <div class="form-group">
                            ...
                            <form method="GET" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="mobile" id="mobile"
                                        placeholder="Enter Your Mobile" type="text" value="<?php echo $_GET['mobile']; ?>">
                                    <?php }else{ ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="password" id="password"
                                        placeholder="Enter Your Password" type="password" value="<?php echo $_GET['password']; ?>">
                                    <?php }else{ ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="r_pass" id="r_pass"
                                        placeholder="Retype Your Password" type="password" value="<?php echo $_GET['r_pass']; ?>">
                                    <?php }else{ ?>
                                    <input type="password" class="form-control" name="r_pass" placeholder="Retype Your Password">
                                    <?php } ?>
                                </div>
                                <div class="block-content">
