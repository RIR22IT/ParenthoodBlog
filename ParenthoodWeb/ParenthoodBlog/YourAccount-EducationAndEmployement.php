			...
			<div class="ui-block">
				<div class="your-profile">
					...
					<div class="ui-block-title">
						<a href="33-YourAccount-Notifications.php" class="h6 title">Notifications</a>
						<a href="#" class="items-round-little bg-primary">8</a>
					</div>
					<div class="ui-block-title">
						<a href="34-YourAccount-ChatMessages.php" class="h6 title">Chat / Messages</a>
					</div>
					<div class="ui-block-title">
						<a href="35-YourAccount-FriendsRequests.php" class="h6 title">Friend Requests</a>
					...
					<div class="ui-block-title">
						<a href="36-FavPage-SettingsAndCreatePopup.php" class="h6 title">Create Fav Page</a>
					</div>
					<div class="ui-block-title">
						<a href="36-FavPage-SettingsAndCreatePopup.php" class="h6 title">Fav Page Settings</a>
					</div>
				</div>
			</div>
		</div>
