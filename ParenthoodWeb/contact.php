...
<body>
                                    ...
                                    <div class="address-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="addon-text">077 202 4066<br>
                                                    011 785 2228</div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="register">
                            <div class="form-content">
                                ...
                                <div class="block-content">
                                    <div><i class="fa fa-shield"></i><span>Your Password at Global Crypto are encrypted
                                            and Secured</span></div>
                                </div>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0RRbNRzzDhEajbOLYfExK5k37ssqNI_A&callback=initMap&libraries=&v=weekly">
    </script>
    <script>
    ...
    function init() {
        ...
        var marker = new google.maps.Marker({
            position: new google.maps.LatLng(6.899907344162203, 79.86387133861886), //Dhaka
            map: map,
            icon: catIcon,
            title: 'Snazzy!',
